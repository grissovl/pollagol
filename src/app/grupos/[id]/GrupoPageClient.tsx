...
import {
  Copy, Check, Users, DollarSign, CheckCircle2, Clock,
  Trash2, UserX, Swords, Trophy,
} from 'lucide-react'
...
function CopyCode({ code }: { code: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="flex items-center gap-1.5 rounded-md border border-gray-200 bg-gray-50 px-3 py-1.5 font-mono text-sm font-semibold tracking-widest text-gray-800 transition-colors hover:bg-gray-100"
    >
